...
const projects = [
  {
    ...
    description: 'A complete e-commerce solution with product management, shopping cart, and payment processing integration.',
  ...
  },
  {
    ...
    description: 'An application that uses machine learning to generate content for marketing, blogs, and social media.',
  ...
  },
  {
    ...
    description: 'A comprehensive solution for managing rental properties, tenants, maintenance, and financial records.',
...
export default function Projects() {
  ...
  return (
    <section ref={sectionRef} className="min-h-screen py-32 relative overflow-hidden bg-background">
      {/* Background pattern */}
      <div className="absolute inset-0 bg-grid-pattern opacity-5 pointer-events-none" />
      
      {/* Metamorphic 3D shapes */}
      <div className="absolute top-20 right-10 w-32 h-32 opacity-30 pointer-events-none hidden md:block">
        <ThreeDCube 
          wireframe={true}
          morphSpeed={0.8}
          rotationSpeed={0.7}
      ...
      <div className="absolute bottom-40 left-20 w-40 h-40 opacity-20 pointer-events-none hidden md:block">
        <ThreeDCube 
          wireframe={true}
          morphSpeed={0.5}
          rotationSpeed={0.5}
        ...
        <div className="relative mt-20">
          ...
          <div className="flex justify-between items-center mb-10">
            ...
            <div className="text-sm text-muted-foreground">
              <span className="text-primary font-medium">{activeIndex + 1}</span>
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="md:w-2/5 p-6 md:p-10 flex flex-col justify-center">
                  ...
                  <div className="mb-8">
                    <h4 className="text-sm text-primary font-semibold mb-3">Technologies Used:</h4>
