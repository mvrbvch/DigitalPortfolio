    ...
    <section ref={sectionRef} className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          <div
            ref={cardRef}
            className="rounded-xl shadow-xl overflow-hidden bg-background/20 backdrop-blur-sm border border-muted/50"
          >
              ...
              <div className="p-8 md:p-12 backdrop-blur-sm">
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="contact-link flex items-center gap-3 hover:translate-x-1 transition-transform">
                    ...
                    <a
                      href="tel:+5535984073125"
                      className="hover:text-primary transition-colors"
                    >
                      +55 19 96000.0848 (WhatsApp)
                    </a>
                  </div>
                  <div className="contact-link flex items-center gap-3 hover:translate-x-1 transition-transform">
                    <Globe className="h-5 w-5 text-primary" />
                    <a
                      href="https://murbach.work"
                      target="_blank"
