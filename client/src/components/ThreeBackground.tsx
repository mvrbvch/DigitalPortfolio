  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (particles.current) {
        ...
        const targetRotationX = particles.current.rotation.x + mousePosition.current.y * 0.0005;
        const targetRotationY = particles.current.rotation.y + mousePosition.current.x * 0.0005;
        ...
        particles.current.scale.set(breathingScale, breathingScale, breathingScale);
      }
