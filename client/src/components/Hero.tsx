...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 backdrop-blur bg-gradient-to-b from-transparent to-background/20" />

      {/* Animated gradient orbs - inspired by Sarah Guo Portfolio */}
      <div className="absolute top-1/4 -left-[10vw] w-[50vw] h-[50vw] rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/10 blur-3xl animate-blob animation-delay-4000"></div>
      <div className="absolute bottom-1/4 -right-[10vw] w-[40vw] h-[40vw] rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 blur-3xl animate-blob"></div>
        ...
        <div className="md:w-2/3">
          ...
          <div className="mb-8">
            <AnimatedText
              ...
              tag="h2"
              className="text-3xl md:text-6xl font-light opacity-100 tracking-wide mb-2"
              splitOptions={{ types: "chars" }}
              delay={0.7}
              // Using the outline style with the Codrops effect
            />
            <div className="text-xl md:text-3xl opacity-1 animate-[fadeIn_0.5s_1.5s_forwards]">
              <span className="creative-development">Creative Development</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-6 justify-center md:justify-start">
            ...
            >
              ...
              <span
                className="absolute inset-0 bg-gradient-to-r from-[#F95738] via-[#EE964B] to-[#F4D35E] opacity-0 
